...
<script type="text/javascript">
            ...
            Stripe.setPublishableKey('pk_text_xxxxxxxxxxxxxxxxxxxxx'); // Your Publishable Key
...
if ($_POST) {
  Stripe::setApiKey("sk_test_xxxxxxxxxxxxxxxxxx");  // Your Secret Key 
  try {
...
<br>
  <div class="col-25">
    <div class="container">
      ...
      <p><a href="#">Your Product Name</a> <span class="price">$9.99</span></p>
      <hr>
